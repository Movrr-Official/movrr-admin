...
export default function PartnerDetailPageClient({
  ...
  if (organisation.isLoading) {
    return (
      <div className="min-h-screen page-canvas flex items-center justify-center text-muted-foreground">
  ...
  if (organisation.isError || !organisation.data) {
    return (
      <div className="min-h-screen page-canvas space-y-4">
        <Button asChild variant="ghost" size="sm">
          <Link href="/rewards/partners">
